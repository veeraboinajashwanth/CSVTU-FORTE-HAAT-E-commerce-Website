...
<!-- Mirrored from jthemes.net/themes/html/neoncart/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2023 05:43:33 GMT -->
<head>
	...
	<body>
		...
		<main>
			...
			================================================== -->
			<section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" data-background="#">
			...
			================================================== -->
			<section class="register_section sec_ptb_140 has_overlay parallaxie clearfix" data-background="assets/images/11.jpg">
				<div class="overlay" data-bg-color="rgba(55, 55, 55, 0.75)"></div>
				<div class="container">
					<div class="reg_form_wrap login_form" data-background="assets/images/55.png">
						<form action="#">
							<div class="reg_form">
								...
								<div class="create_account text-center">
									...
									<a class="create_account_btn text-uppercase" href="signup.php">Sign Up</a>
								</div>
							</div>
						</form>
					</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="footer_widget footer_useful_links clearfix">
								...
								<ul class="ul_li_block clearfix">
									...
									<li><a href="location.php">Loction</a></li>
...
<!-- Mirrored from jthemes.net/themes/html/neoncart/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2023 05:43:35 GMT -->
</html>